...
import com.era7.bioinfo.uniprotneo4jmodel.model.neo4j.relationships.protein.ProteinDatasetRel;
import com.era7.bioinfo.uniprotneo4jmodel.model.neo4j.relationships.protein.ProteinOrganismRel;
...
public class ProteinNode extends BasicEntity {
    ...
    public static final String PROTEIN_INTACT_ID_INDEX = "protein_intact_id_index";
    ...
    public String getIntactId(){
        return String.valueOf(node.getProperty(INTACT_ID));
    }
    ...
    public void setIntactId(String value){
        node.setProperty(INTACT_ID, value);
    }
